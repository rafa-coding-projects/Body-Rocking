...
author0 = r'nastaran\CNN_ESDB_v2'
author1 = r'nastaran\Boxuan_ESDB_widernet8x_dense128'
author2 = r'nastaran\Boxuan_ESDB_widernet8x_dense128'
author3 = r'nastaran\Boxuan_ESDB_widernet8x_dense128_utopic'
author4 = r'nastaran\Boxuan_ESDB_widernet8x_dense128_utopic'
author5 = r'nastaran\Boxuan_ESDB_widernet8x_dense128_utopic'
...
orig_path6 = r'C:\path\to\src\bayes_approach_' + author6
orig_path7 = r'C:\path\to\src\bayes_approach_' + author7
...
# thr_pair = [[0.4, 0.85], [0.6, 0.95], [0.5, 0.9], [0.4, 0.85], [0.3, 0.8], [0.2, 0.75], [0.1, 0.65]]
...
use_unc = [False, False, False, True, True, True, False, False]
#0 - run original, 1 - run Bayes, -1, skip original
use_bayes = [0, 0, 1, -2, -2, -2, -2, -2]
...
# legends = ['WiderNet 2x', 'WiderNet 2x - Bayes', 'WiderNet 4x', 'WiderNet 4x - Bayes', 'WiderNet 8x', 'WiderNet 8x - Bayes', 'WiderNet 16x', 'WiderNet 16x - Bayes']
legends = ['Rad approach', 'WiderNet 8x', 'WiderNet 8x-Bayesian', 'WiderNet 8x (Utopian)-Cal. Prob. Sel.', 'WiderNet 8x - Bayes', 'WiderNet 16x', 'WiderNet 16x - Bayes']
ind = 0
...
for z in list_of_dicts:
    ...
    if use_unc[ind]:
        ...
        #              lw=4, alpha=.8)
        ax.plot(z['mean_fpr'], z['mean_tpr_unc'][(i[ind]+1)//-1],
                     label=legends[ind] + ', AUC = {:0.2f} $\pm$ {:0.2f}, prec.: {:0.2f}'.format(z['mean_auc_unc'][(i[ind]+1)//-1], z['std_auc_unc'][(i[ind]+1)//-1],
                                                                          z['precision_unc'][(i[ind]+1)//-1], lw=4, alpha=.8))
