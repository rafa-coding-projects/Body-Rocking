...
suffixs = ['', '', '_ent0.40cal0.85', '', '', '_ent0.40cal0.85']

paths = [orig_path0, orig_path1, orig_path2, orig_path3, orig_path4, orig_path5]
...
legends = ['Rad approach', 'WiderNet 8x', 'WiderNet 8x-Bayesian', 'WiderNet 8x (Utopic)-Entropy. Sel.', 'WiderNet 8x (Utopic)-Cal. Prob. Sel.', 'WiderNet 8x - Bayes', 'WiderNet 16x', 'WiderNet 16x - Bayes']
ind = 0
...
ax.set_xlabel('FalsePositive Rate', fontsize=40)
